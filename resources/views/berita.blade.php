  ...
  <header id="header">
    <div class="container d-flex" style="align-items:center;">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="{{url('')}}"><img src="img/logo_ponpes.png"></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="{{route('berita')}}">Berita</a></li>
        ...
        <div class="row">
          ...
          @foreach($berita as $brt)
            <article class="entry" data-aos="fade-up">
              ...
              <div class="entry-img">
                <img src="data_berita/{{$brt->gambar}}" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="/detailberita/{{$brt->id}}">{{$brt->judul}}</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="blog-single.html">Pondok Pesantren Darul Ilmi Meteseh</a></li>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single.html"><time datetime="{{$brt->tgl_upload}}">{{$brt->tgl_upload}}</time></a></li>
                </ul>
              </div>

              <div class="entry-content">
                <div class="read-more">
                  <a href="/detailberita/{{$brt->id}}">Read More</a>
                </div>
              </div>

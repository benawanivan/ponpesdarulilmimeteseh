          ...
          <div class="col-lg-12 entries">
            ...
            <article class="entry entry-single" data-aos="fade-up" >
              <div style="text-align:center">
                <img src="../data_berita/{{$berita->gambar}}" alt="Foto" class="img-fluid" style="max-height: 400px;">
              </div>
              <div style="text-align:justify">
                <h2 class="entry-title" style="padding-top:2rem">
                  <a>{{$berita->judul}}</a>
                </h2>

                <div class="entry-meta">
                  <ul>
                    <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="blog-single.html">Pondok Pesantren Darul Ilmi</a></li>
                    <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single.html"><time datetime="{{$berita->tgl_upload}}">{{$berita->tgl_upload}}</time></a></li>
                  </ul>
                </div>

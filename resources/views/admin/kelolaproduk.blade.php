...
<body>
  ...
  <header id="header">
    <div class="container d-flex" style="align-items:center;">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li><a href="{{route('kelolaberita')}}">Kelola Berita</a></li>
  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <a href="{{ route('tambahproduk') }}" class="btn btn-success btn-sm mb-2">Tambah Produk</a>
            @if (session('success'))
            ...
            <table class="table">
                ...
                @foreach($product as $prd)
                  <tr>
                    ...
                    <td>{{$prd->nama}}</td>
                    <td><img src="data_produk/{{ $prd->gambar }}" style="width:300px"></td>
                    <td>{{$prd->harga}}</td>
                    <td>
                      <div class="row" style="justify-content:center">
                          <form action="/delete2/{{$prd->id}}" method="get" style="padding-right:2px;padding-left:2px">
                              @csrf
                              <div class="">
